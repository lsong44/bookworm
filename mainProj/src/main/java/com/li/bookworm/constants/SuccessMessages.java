...
public class SuccessMessages {
    public static final String ADD_MEMBER_MESSAGE = "Successfully added a new member.";
    public static final String DELETE_MEMBER_MESSAGE = "Successfully deleted an existing member.";
    public static final String EDIT_MEMBER_MESSAGE = "Successfully edited an existing member.";
    ...
    public static final String DELETE_GROUP_MESSAGE = "Successfully deleted an existing group.";
    public static final String EDIT_GROUP_MESSAGE = "Successfully edited an existing group.";
    public static final String ADD_BOOK_LOG_MESSAGE = "Successfully added a log.";
